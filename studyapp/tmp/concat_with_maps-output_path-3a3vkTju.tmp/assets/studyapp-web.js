...
define('studyapp-web/controllers/learn-more', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Controller.extend({
...
define('studyapp-web/routes/learn-more', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Route.extend({});
});
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child3 = (function () {
      ...
      return {
        ...
        statements: [["block", "link-to", ["learn-more"], ["class", "no-underline"], 0, null, ["loc", [null, [19, 2], [19, 100]]]]],
        locals: [],
        templates: [child0]
      };
    })();
    var child4 = (function () {
      ...
      return {
        ...
        statements: [["block", "link-to", ["learn-more"], ["class", "no-underline"], 0, null, ["loc", [null, [22, 2], [22, 100]]]]],
        locals: [],
        templates: [child0]
      };
    })();
    return {
      ...
      statements: [["block", "link-to", ["landing"], ["class", "no-underline"], 0, null, ["loc", [null, [2, 1], [2, 147]]]], ["block", "if", [["get", "session.isAuthenticated", ["loc", [null, [4, 8], [4, 31]]]]], [], 1, 2, ["loc", [null, [4, 2], [15, 9]]]], ["block", "unless", [["get", "session.isAuthenticated", ["loc", [null, [17, 11], [17, 34]]]]], [], 3, 4, ["loc", [null, [17, 1], [24, 12]]]], ["content", "outlet", ["loc", [null, [26, 0], [26, 10]]]]],
      locals: [],
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el4 = dom.createTextNode(" Discover Your Potential");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("	\n	");
        dom.appendChild(el2, el3);
...
if (!runningTests) {
  require("studyapp-web/app")["default"].create({"name":"studyapp-web","version":"0.0.0+d293d5b3"});
}
